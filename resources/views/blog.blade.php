...
<div class="text-center mb-4">
  <h1 class="fw-bold text-brown">
    {{ $lang==='id' ? 'Blog Saya' : 'My Blog' }}
  </h1>
  <p class="lead">
    {{ $lang==='id'
      ? 'Berbagi ide, refleksi, dan proyek yang membentuk perjalanan saya.'
      : 'Insights, reflections, and projects that shaped my journey.'
    }}
  </p>
</div>
...
<div class="row g-4 mt-4">
  ...
  {{-- Tambahan konten dari database --}}
  @foreach($blogs as $blog)
    <x-blog-card 
      :title="$blog->title" 
      :text="Str::limit($blog->content, 120)" 
    />
  @endforeach
</div>
@endsection
